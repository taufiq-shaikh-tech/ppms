...
export default function DoctorMessages() {
  ...
  const selectedDisplayName =
    selectedUserInfo?.name || "selected user";

  const renderMessageBubble = (m) => {
    const fromMe = m.sender?._id === user?.id || m.sender === user?.id;
    return (
      <div
        key={m._id}
        style={{
  ...
  return (
    <div>
      ...
      <p className="page-subtitle">
        Chat with your patients and admins in a single inbox.
      </p>
        ...
        <div className="section">
          ...
          {loadingThreads ? (
            ...
            <p style={{ fontSize: "12px", color: "#6b7280" }}>
              No conversations yet. Patients can start messaging you from their
              portal.
            </p>
          ) : (
            <ul
